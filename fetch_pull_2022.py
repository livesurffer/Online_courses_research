...
csv_file='/home/acronym/data_analysis/Global-research_of_changing_work_model/survey_2022_2023/survey_results_public_2022.csv'
table_name='survey_22'
...
with open(csv_file,newline='') as csvf:
	...
	for row in thereader:
		filter_row = [row[i] for i in columns_for_analisys]		
